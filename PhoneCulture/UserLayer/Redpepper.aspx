<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Redpepper.aspx.cs" Inherits="PhoneCulture.WebForm12" %>
...
<ul class="nav nav-pills justify-content-center">
  <li class="nav-item">
    <a class="nav-link" href="CanvasDiary.aspx">Canvas Diary
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="Redpepper.aspx">Redpepper</a>
  </li>
  <li class="nav-item">
...
<div class="container carouselProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-interval="false">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" runat="server" src="../Images/RedpepperBlack.jpeg" alt="First slide"/>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="../Images/RedPepperCyan.jpeg" alt="Second slide"/>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="../Images/RedPepperWhite.jpeg" alt="Third slide"/>
                </div>
              </div>
        ...
        <div class="col-sm-6">
                <h3>Redpepper</h3>
                <p>These cases are great quality protective cases. They have ip68 water and dust resistance which means you can drop them in the pool and not worry!</p>
                <h2>Price: $70.00</h2>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <asp:ListItem Text="Cyan" Value="2"></asp:ListItem>
                        <asp:ListItem Text="Pink" Value="3"></asp:ListItem>
