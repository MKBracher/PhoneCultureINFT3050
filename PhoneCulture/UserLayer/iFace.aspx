<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="iFace.aspx.cs" Inherits="PhoneCulture.WebForm14" %>
...
<ul class="nav nav-pills justify-content-center">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="iFace.aspx">iFace</a>
  </li>
  <li class="nav-item">
...
<div class="container carouselProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-interval="false">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="../Images/iFaceBlue.jpeg" alt="First slide"/>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="../Images/iFaceGold.jpeg" alt="Second slide"/>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="../Images/iFacePink.jpeg" alt="Third slide"/>
                </div>
              </div>
        ...
        <div class="col-sm-6">
                <h3>iFace</h3>
                <p>Stylish and simple, with a high silicone bumper to protect the face and a rubber grip to stop you dropping your phone.</p>
                <h2>Price: $35.00</h2>
