<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="X-Doria.aspx.cs" Inherits="PhoneCulture.WebForm13" %>
...
<ul class="nav nav-pills justify-content-center">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="X-Doria.aspx">X-Doria Defense</a>
  </li>
</ul>
...
<div class="container carouselProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-interval="false">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="../Images/XDoriaBlack.jpeg" alt="First slide"/>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="../Images/XDoriaIridescent.jpeg" alt="Second slide"/>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="../Images/XDoriaRed.jpeg" alt="Third slide"/>
                </div>
              </div>
        ...
        <div class="col-sm-6">
                <h3>X-Doria Defense</h3>
                <p>Our top of the line defense cases! These are 3 metre drop tested and have a clear back so you can see the phone you paid so much for!</p>
                <h2>Price: $70.00</h2>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <asp:ListItem Text="Iridescent" Value="2"></asp:ListItem>
